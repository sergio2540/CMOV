...
public class ABGameRenderer implements Renderer {
	...
	private ABBackGround background1 = new ABBackGround();
	private ABBackGround background2 = new ABBackGround();

	private float bgScroll1;
	private float bgScroll2;

	private ABAchmed playerAchmed = new ABAchmed();

	private ABAchmedPlayer achmed = new ABAchmedPlayer();

	private ABTileMap abTileMap = new ABTileMap();
