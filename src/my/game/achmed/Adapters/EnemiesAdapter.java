...
public class EnemiesAdapter extends ArrayAdapter<String> {

	private  List<String> peersToInflate;

	public EnemiesAdapter(Context context, int resource, List<String> peers) {
	...
	public View getView(int position, View convertView, ViewGroup parent){
		 ...
		 */
		String p = peersToInflate.get(position);
