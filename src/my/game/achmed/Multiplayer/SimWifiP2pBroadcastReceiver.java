...
public class SimWifiP2pBroadcastReceiver extends BroadcastReceiver {
    ...
    private ChatRoom mActivity;

    //public SimWifiP2pBroadcastReceiver(SimpleChatActivity activity) {
     public SimWifiP2pBroadcastReceiver(ChatRoom activity) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (SimWifiP2pBroadcast.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
        	...
        	SimWifiP2pInfo ginfo = (SimWifiP2pInfo) intent.getSerializableExtra(
        			SimWifiP2pBroadcast.EXTRA_GROUP_INFO);
        	ginfo.print();
        	Toast.makeText(mActivity, ginfo.getDeviceName() + ":" + (ginfo.askIsGO() ? "GO" : "NOT GO!"),Toast.LENGTH_LONG).show();/////novaaaaa
        	
        	ChatRoom.gos.add(ginfo.getDeviceName());
