...
public class SimpleChatActivity extends Activity{
	...
	private WifiP2pSocketServer mSrvSocket = null;
	//private ReceiveCommTask mComm = null;
	private WifiP2pSocket mCliSocket = null;
	...
	private OnClickListener listenerWifiOnButton = new OnClickListener() {
        public void onClick(View v){
        	...
        	Intent intent2 = new Intent(v.getContext(), SimWifiP2pService.class);
...
*/
	...
	private void guiSetButtonListeners() {
		...
		findViewById(R.id.rooms).setOnClickListener(listenerWifiOnButton);
